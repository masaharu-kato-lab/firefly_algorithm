...
def main():
    ...
    argp.add_argument('-t'   , '--stat_types' , type=str, nargs='+', default=['mean'], choices=['min', 'max', 'mean', 'sd'], help='Statistic value types')
    argp.add_argument('-uitr', '--use_iters'  , action='store_true', help='Use iterations to get value')
    ...
    for _input in args.input:
        ...
        if args.use_iters:
            ...
            values = binary.bests_by_seed.values()
